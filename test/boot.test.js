...
ok(main.includes("app.setAppUserModelId('com.darkgrid.app')") && main.includes("win.setIcon(path.join(__dirname, 'assets', 'darkgrid-pokeball.ico'))") && main.includes("icon: path.join(__dirname, 'assets', 'darkgrid-pokeball.ico')"), 'ícone DarkGrid e AppUserModelId são aplicados à janela e à barra de tarefas');
